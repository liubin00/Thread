 ...
 * @data2021/3/517:29
 */
public class ThreadLocalTestRemove {
        ...
        for (int i = 0; i < 2; i++) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    myThreadLocal.setName("user" + data);
    ...
    static class B {
        public void get() {
            ...
            System.out.println("A线程" + Thread.currentThread().getName() + "的name" + BThreadLocal.getName() + "   age" + BThreadLocal.getAge());
        }
    }
    ...
    static class MyThreadLocal {
        ...
        private static ThreadLocal<MyThreadLocal> mapThreadLocal = new ThreadLocal<>();
